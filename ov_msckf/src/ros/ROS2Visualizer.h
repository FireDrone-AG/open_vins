...
#include "ov_interfaces/msg/gimbal_stamped.hpp"
...
public:
  ...
  void callback_gimbal(const ov_interfaces::msg::GimbalStamped::SharedPtr msg);
...
protected:
  ...
  rclcpp::Subscription<ov_interfaces::msg::GimbalStamped>::SharedPtr sub_gimbal;
